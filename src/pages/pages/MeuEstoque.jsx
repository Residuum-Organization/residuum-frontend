...
import { MapPin, RefreshCw, Home, Barcode, Star, Trash2 } from 'lucide-react'

const itensIniciais = [
  { id: 1, nome: 'Garrafa Pet 2L', codigo: '7891000053508', quantidade: 2, pontos: 40, icon: 'solar:bottle-bold' },
  { id: 2, nome: 'Alumínio 350ml', codigo: '7891000053509', quantidade: 10, pontos: 10, icon: 'solar:can-bold' },
  { id: 3, nome: 'Garrafa Pet 1L', codigo: '7891000053508', quantidade: 1, pontos: 20, icon: 'solar:bottle-bold' },
  { id: 4, nome: 'Garrafa Pet 500ml', codigo: '7891000053508', quantidade: 3, pontos: 60, icon: 'solar:bottle-bold' },
]
