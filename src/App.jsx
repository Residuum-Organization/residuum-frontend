  ...
  return (
    <main className="min-h-screen bg-slate-100 px-4 py-8">
      <section className="mx-auto w-full max-w-3xl rounded-3xl bg-white p-6 shadow-lg md:p-8">
        <p className="text-sm font-semibold uppercase tracking-wide text-emerald-600">Residuum</p>
        <h1 className="mt-2 text-3xl font-bold text-slate-900">Fluxo de demonstracao</h1>
        <p className="mt-2 text-slate-600">Navegue pelas telas para apresentar o produto ponta a ponta.</p>

        <ol className="mt-6 space-y-3 text-slate-700">
          <li className="rounded-xl border border-slate-200 p-4">1. Perfil do usuario</li>
          <li className="rounded-xl border border-slate-200 p-4">2. Cadastro de residuo</li>
          <li className="rounded-xl border border-slate-200 p-4">3. Gestao do estoque</li>
          <li className="rounded-xl border border-slate-200 p-4">4. Busca de ponto no mapa</li>
          <li className="rounded-xl border border-slate-200 p-4">5. Painel de coleta de dados</li>
          <li className="rounded-xl border border-slate-200 p-4">6. Escanear QR Code no ponto</li>
          <li className="rounded-xl border border-slate-200 p-4">7. Validacao de presenca no local</li>
        </ol>
      </section>
    </main>
  )
